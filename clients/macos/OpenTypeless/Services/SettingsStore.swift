...
private enum SettingsStoreRuntime {
   ...
   static let appStorageStore: UserDefaults? = {
      ...
      let suiteName =
         ...
         ?? "com.yisu.opentypeless.settings.tests.\(ProcessInfo.processInfo.processIdentifier)"
...
final class SettingsStore: ObservableObject {
   ...
   var translateOutputLanguage: String = Defaults.Hotkeys.translateOutputLanguage
    ...
    @AppStorage(OpenTypelessThemeStorageKeys.themeMode, store: SettingsStoreRuntime.appStorageStore)
    var themeMode: String = Defaults.themeMode {
      didSet { notifyThemeDidChange() }
   }
   @AppStorage(OpenTypelessThemeStorageKeys.lightThemePresetID, store: SettingsStoreRuntime.appStorageStore)
   var lightThemePresetID: String = Defaults.lightThemePresetID {
      didSet { notifyThemeDidChange() }
   }
   @AppStorage(OpenTypelessThemeStorageKeys.darkThemePresetID, store: SettingsStoreRuntime.appStorageStore)
   ...
   private let keychainService = "com.yisu.opentypeless.settings"
   ...
   var selectedLightThemePreset: OpenTypelessThemePreset {
      OpenTypelessThemePresetCatalog.preset(withID: lightThemePresetID)
   }

   var selectedDarkThemePreset: OpenTypelessThemePreset {
      OpenTypelessThemePresetCatalog.preset(withID: darkThemePresetID)
   }
