...
extension Notification.Name {
    static let historyStoreDidChange = Notification.Name("com.yisu.opentypeless.historyStoreDidChange")
}
...
final class HistoryStore {
    ...
    func fetchVoiceTranscriptions(
        ...
        var descriptor = allTranscriptionsDescriptor(query: query)
        descriptor.fetchLimit = limit
    ...
    func fetchAllVoiceTranscriptions(query: String = "") throws -> [TranscriptionRecord] {
        let descriptor = allTranscriptionsDescriptor(query: query)
    ...
    private func allTranscriptionsDescriptor(query: String) -> FetchDescriptor<TranscriptionRecord> {
