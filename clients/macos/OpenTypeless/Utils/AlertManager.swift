...
final class AlertManager {
    ...
    func showAccessibilityPermissionAlert() {
        ...
        alert.informativeText = localized("""
            OpenTypeless needs Accessibility permission to insert text at your cursor.
            
            To grant permission:
            1. Click "Open System Settings" below
            2. Click the + button
            3. Navigate to the app shown in Finder
            4. Restart OpenTypeless after granting permission
    ...
    func showMicrophonePermissionAlert() {
        ...
        alert.informativeText = localized("OpenTypeless needs microphone access to record and transcribe your voice.\n\nPlease grant permission in System Settings.", locale: locale)
