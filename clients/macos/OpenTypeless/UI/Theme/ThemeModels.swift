...
enum OpenTypelessThemeMode: String, CaseIterable, Identifiable {
    case system
    case light
    case dark
...
struct OpenTypelessThemeProfile: Hashable {
...
struct OpenTypelessThemePreset: Hashable, Identifiable {
    let id: String
    let title: String
    let summary: String
    ...
    let lightTheme: OpenTypelessThemeProfile
    let darkTheme: OpenTypelessThemeProfile

    func profile(for variant: OpenTypelessThemeVariant) -> OpenTypelessThemeProfile {
        switch variant {
        case .light:
            return lightTheme
        case .dark:
...
enum OpenTypelessThemePresetCatalog {
    static let defaultPresetID = "opentypeless"

    static let presets: [OpenTypelessThemePreset] = [
        OpenTypelessThemePreset(
            id: "opentypeless",
            title: "OpenTypeless",
            ...
            lightTheme: OpenTypelessThemeProfile(
                accentHex: "#C56E42",
            ...
            darkTheme: OpenTypelessThemeProfile(
                accentHex: "#E19260",
    ...
    static func preset(withID id: String?) -> OpenTypelessThemePreset {
    ...
    static func profile(for id: String?, variant: OpenTypelessThemeVariant) -> OpenTypelessThemeProfile {
