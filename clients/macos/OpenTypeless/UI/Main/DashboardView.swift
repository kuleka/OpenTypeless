        ...
        VStack(alignment: .leading, spacing: AppTheme.Spacing.md) {
            ...
            HStack(alignment: .top) {
                ...
                HStack(spacing: AppTheme.Spacing.md) {
                    ...
                    Text(localized("to dictate and let OpenTypeless transcribe for you", locale: locale))
            ...
            // Description
            Text(localized("Press and hold to dictate in any app. OpenTypeless will transcribe your speech and insert the text where your cursor is.", locale: locale))
                .font(AppTypography.body)
                .foregroundStyle(AppColors.textSecondary)
                .lineLimit(2)
