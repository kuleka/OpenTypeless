...
final class StatusBarController: NSObject, NSMenuDelegate {
    ...
    private func setupStatusItem() {
        ...
        if let button = statusItem?.button {
            if let customIcon = NSImage(named: "OpenTypelessIcon") {
    ...
    private func setupMenu() {
        ...
        let quitItem = NSMenuItem(
            title: localized("Quit OpenTypeless", locale: locale),
    ...
    private func getBaseIcon() -> NSImage? {
        ...
        guard let customIcon = NSImage(named: "OpenTypelessIcon") else {
            return NSImage(systemSymbolName: "mic.fill", accessibilityDescription: "OpenTypeless")
        }
