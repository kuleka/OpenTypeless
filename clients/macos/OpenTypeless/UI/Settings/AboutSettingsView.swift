...
struct AboutSettingsView: View {
   ...
   private var appInfoSection: some View {
      SettingsCard(title: localized("About OpenTypeless", locale: locale), icon: "mic.fill") {
   ...
   private var acknowledgmentsSection: some View {
      SettingsCard(title: localized("Acknowledgments", locale: locale), icon: "heart.fill") {
         VStack(alignment: .leading, spacing: AppTheme.Spacing.md) {
            ...
            Link(destination: URL(string: "https://github.com/kuleka/OpenTypeless")!) {
               HStack {
                  Text("OpenTypeless on GitHub")
                     .font(AppTypography.body)
                     .foregroundStyle(AppColors.textPrimary)
                  Spacer()
                  Image(systemName: "arrow.up.right.square")
   ...
   private var linksSection: some View {
      SettingsCard(title: localized("Support", locale: locale), icon: "questionmark.circle.fill") {
         VStack(alignment: .leading, spacing: AppTheme.Spacing.md) {
            Link(destination: URL(string: "https://github.com/kuleka/OpenTypeless/issues")!) {
               HStack {
   ...
   private func copySystemInfo() {
      let info = """
         OpenTypeless: \(appVersion) (\(buildNumber))
