...
struct GeneralSettingsView: View {
    ...
    private var interfaceSection: some View {
        SettingsCard(
            ...
            icon: "macwindow",
            detail: localized("Control how OpenTypeless appears in macOS and whether it starts with your desktop session.", locale: locale)
        ) {
            VStack(spacing: AppTheme.Spacing.lg) {
                SettingsToggleRow(
                    title: localized("Launch at login", locale: locale),
                    detail: localized("Automatically start OpenTypeless when you sign in.", locale: locale),
                ...
                SettingsToggleRow(
                    ...
                    detail: localized("Display OpenTypeless in the Dock instead of running only as a menu bar app.", locale: locale),
    ...
    private var audioInputSection: some View {
        SettingsCard(
            ...
            icon: "mic",
            detail: localized("Choose which microphone OpenTypeless should use for dictation and how it behaves while recording.", locale: locale)
        ) {
            VStack(alignment: .leading, spacing: AppTheme.Spacing.lg) {
