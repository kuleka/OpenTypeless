...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func setupMainMenu() {
        ...
        appMenu.addItem(NSMenuItem(title: localized("About OpenTypeless", locale: currentLocale), action: #selector(NSApplication.orderFrontStandardAboutPanel(_:)), keyEquivalent: ""))
        ...
        appMenu.addItem(NSMenuItem.separator())
        appMenu.addItem(NSMenuItem(title: localized("Quit OpenTypeless", locale: currentLocale), action: #selector(NSApplication.terminate(_:)), keyEquivalent: "q"))
...
final class SwiftDataStoreRepairService {
    ...
    func prepareStoreLocation() throws {
        ...
        guard legacyStoreVersion != nil else {
            Log.app.warning(
                "Ignoring legacy SwiftData store at \(legacyStoreURL.path) because it does not match the OpenTypeless schema"
            )
            return
        }
