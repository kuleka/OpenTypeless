...
struct MentionFormatterTests {
    private func makeIndexedFile(
        absolutePath: String = "/workspace/OpenTypeless/Services/AppCoordinator.swift",
        relativePath: String = "OpenTypeless/Services/AppCoordinator.swift",
    ...
    private func makeCandidate(relativePath: String = "OpenTypeless/Services/AppCoordinator.swift", score: Double = 0.9) -> PathCandidate {
    ...
    @Test func formatsResolvedMentionForSupportedApp() {
        ...
        #expect(text == "@OpenTypeless/Services/AppCoordinator.swift")
        #expect(path == "OpenTypeless/Services/AppCoordinator.swift")
    ...
    @Test func idempotentForAlreadyFormattedMention() {
        let result = sut.formatMention(
            originalText: "@OpenTypeless/Services/AppCoordinator.swift",
            resolution: .resolved(makeCandidate(score: 0.9)),
            capabilities: cursorCapabilities
        )
    ...
    @Test func differentPrefixPerApp() {
        ...
        #expect(vscodeText == "@OpenTypeless/Services/AppCoordinator.swift")
        ...
        #expect(zedText == "/OpenTypeless/Services/AppCoordinator.swift")
    }
    ...
    @Test func batchFormatReport() {
        ...
        #expect(report.formattedText.contains("@OpenTypeless/Services/AppCoordinator.swift"))
