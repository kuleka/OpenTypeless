...
struct MediaIngestionServiceTests {
    private let fakeYTDLPPath = "/tmp/opentypeless-test-yt-dlp"
    private let fakeFFmpegPath = "/tmp/opentypeless-test-ffmpeg"
...
private final class MockProcessRunner: ProcessRunning, @unchecked Sendable {
    ...
    var expectedYTDLPPath = "/tmp/opentypeless-test-yt-dlp"
    var expectedFFmpegPath = "/tmp/opentypeless-test-ffmpeg"
