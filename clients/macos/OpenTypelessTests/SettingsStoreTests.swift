...
struct SettingsStoreTests {
    ...
    @Test func testThemeModeBridgesStoredValue() {
        ...
        #expect(settingsStore.themeMode == OpenTypelessThemeMode.light.rawValue)
    ...
    @Test func testThemePresetFallsBackToDefaultForUnknownPresetID() {
        ...
        #expect(settingsStore.selectedLightThemePreset.id == OpenTypelessThemePresetCatalog.defaultPresetID)
        #expect(settingsStore.selectedDarkThemePreset.id == OpenTypelessThemePresetCatalog.defaultPresetID)
    }

    @Test func testThemeModeMapsToAppKitAppearance() {
        #expect(OpenTypelessThemeMode.system.appKitAppearanceName == nil)
        #expect(OpenTypelessThemeMode.light.appKitAppearanceName == .aqua)
        #expect(OpenTypelessThemeMode.dark.appKitAppearanceName == .darkAqua)
    }
