...
@MainActor
@Suite(.enabled(if: ProcessInfo.processInfo.environment["OPENTYPELESS_RUN_INTEGRATION_TESTS"] == "1", "PermissionManager integration tests are disabled by default. Run `just test-integration` to execute them."))
